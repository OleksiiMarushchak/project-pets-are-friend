import{a as y,i as v}from"./assets/vendor-CLTxG5yw.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const p of i.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&n(p)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector("[data-menu]"),t=document.querySelector("[data-header-menu-open]"),s=document.querySelector("[data-header-menu-close]"),n=document.querySelectorAll("[data-menu-close]");t.addEventListener("click",()=>{e.classList.add("active"),document.body.style.overflow="hidden"}),s.addEventListener("click",()=>{o()}),n.forEach(i=>{i.addEventListener("click",()=>{o()})}),e.addEventListener("click",i=>{i.target===e&&o()});function o(){e.classList.remove("active"),document.body.style.overflow=""}});const d=document.querySelector(".js-pet-list-categories"),a=document.querySelector(".js-pets-list-cards"),u=document.querySelector(".js-showmore-btn"),b=document.querySelector(".js-loader");let l=[],r=0,c=[];async function P(){var e,t;try{const n=(await y.get("https://paw-hut.b.goit.study/api/categories")).data;j(n)}catch(s){v.error({title:"Помилка",message:((t=(e=s.response)==null?void 0:e.data)==null?void 0:t.message)||"Неможливо завантажити дані"})}}async function S(){var e,t;try{l=(await y.get("https://paw-hut.b.goit.study/api/animals",{params:{page:1,limit:30}})).data.animals,c=l,L(l)}catch(s){v.error({title:"Помилка",message:((t=(e=s.response)==null?void 0:e.data)==null?void 0:t.message)||"Неможливо завантажити дані"})}}function j(e){const t=`<li class="pets-list-categories-item">
      ...
      </li>`}function f(){return window.innerWidth>=1440?9:8}function L(e){a.innerHTML="",r=0;const t=f(),s=e.slice(0,t);if(!s.length){a.innerHTML="<p>Нажаль наразі не має доступних хатніх тваринок 😞 </p>",m();return}const n=s.map(w).join("");a.insertAdjacentHTML("afterbegin",n),r=s.length,r>=e.length?m():h()}function w(e){return`<li class="petlist-pet-card" data-id="${e._id}">
      <img
        class="pet-image"
    ...
    </li>`}function $(e){const t=f(),s=e.slice(r,r+t);if(s.length===0){m();return}const n=s.map(w).join("");a.insertAdjacentHTML("beforeend",n),r+=s.length,h()}document.addEventListener("DOMContentLoaded",async()=>{await Promise.all([S(),P()]),E()});d.addEventListener("click",async e=>{e.preventDefault();const t=e.target.closest("button.category-btn");if(!t||!d.contains(t))return;q(),a.innerHTML="",await new Promise(n=>setTimeout(n,300));const s=t.dataset.name;c=M(s),L(c),d.querySelectorAll(".category-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),E()});window.addEventListener("resize",()=>{L(c.slice(0,r||f()))});u.addEventListener("click",()=>{$(c)});a.addEventListener("click",e=>{const t=e.target.closest(".js-pet-more-btn");if(!t)return;const n=t.closest(".petlist-pet-card").dataset.id;console.log("Дізнатися більше",n)});function M(e){return e==="all"?l:l.filter(t=>{var s;return(s=t.categories)==null?void 0:s.some(n=>n&&n.name===e)})}function E(){b.classList.add("hidden"),h()}function q(){b.classList.remove("hidden"),m()}function h(){r<c.length?u.classList.remove("hidden"):u.classList.add("hidden")}function m(){u.classList.add("hidden")}const g=document.querySelector(".scroll-to-top");window.addEventListener("scroll",function(){window.scrollY>300?g.classList.add("visible"):g.classList.remove("visible")});g.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});
